...
class EditorActivity : AppCompatActivity() {
        ...
        private val trimLauncher =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                ...
                if (result.resultCode == RESULT_OK) {
                    ...
                    trimEnd =
                        result.data?.getLongExtra("TRIM_END", player.duration) ?: player.duration
        ...
        private fun applyVideoFilter(filter: RgbFilter) {
            ...
            player.setVideoEffects(listOf(filter))
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            run {
                ...
                if (isVideo) {
                    ...
                    player.prepare()
                    player.play()
                    val textureView = videoPreview.videoSurfaceView as? TextureView


                    Toast.makeText(
                        this,
                        if (textureView != null) "TextureView Found" else "TextureView NOT Found",
                        Toast.LENGTH_SHORT
                    ).show()
                        ...
                        filterRecyclerView.adapter =
                            FilterAdapter(filters) { filter ->
                                ...
                                when (filter.name) {
                                    ...
                                    "B&W" -> {
                                        Toast.makeText(this, "B&W clicked", Toast.LENGTH_SHORT)
                                            .show()
