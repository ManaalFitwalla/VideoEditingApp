...
class GalleryActivity : AppCompatActivity() {
    ...
    private lateinit var txtBottomCountText: TextView
    private lateinit var btnProceed: Button
    private lateinit var bottomBarContainer: ConstraintLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtBottomCountText = findViewById(R.id.txtBottomCountText)
        ...
        // Keep the container invisible initially
        ...
        adapter = MediaAdapter(
            ...
            { count ->
                ...
                txtBottomCountText.text = "$count Item Selected"

                // FIXED: We show/hide the whole container, not just the button!
                if (count > 0) {
    ...
    private fun loadMedia(type: String): MutableList<MediaItem> {
        ...
        cursor?.use {
            ...
            while (it.moveToNext()) {
                ...
                list.add(MediaItem(contentUri, mediaType == MediaStore.Files.FileColumns.MEDIA_TYPE_VIDEO))
            }
        }
        return list
    }
